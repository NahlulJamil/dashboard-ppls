    ...
    <div class="max-w-md mx-auto bg-white rounded shadow p-6">
        ...
        <form action="{{ route('admins.update', $admin->id_admin) }}" method="POST">
            ...
            <div class="mb-6 relative">
                <input type="text" name="username" placeholder="Username" value="{{ $admin->username }}"
                    class="w-full border-b border-gray-300 pb-2 focus:outline-none focus:border-blue-500 text-gray-700 placeholder-gray-400"required>
            </div>
            ...
            <div class="mb-6 text-xs space-y-1">
                <p class="text-gray-400 italic">Kosongkan jika tidak ingin mengubah password</p>
